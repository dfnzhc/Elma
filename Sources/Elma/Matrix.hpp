...
template<typename T> struct TMatrix4x4
{
    ...
    template<typename T2> TMatrix4x4(const T2* arr)
    {
        for (int i = 0; i < 4; i++) {
            for (int j = 0; j < 4; j++) {
    ...
    template<typename T2> TMatrix4x4(const TMatrix4x4<T2>& m)
    {
        for (int i = 0; i < 4; i++) {
            for (int j = 0; j < 4; j++) {
    ...
    {
        data[0][0] = (T)v00; data[0][1] = (T)v01; data[0][2] = (T)v02; data[0][3] = (T)v03;
        data[1][0] = (T)v10; data[1][1] = (T)v11; data[1][2] = (T)v12; data[1][3] = (T)v13;
        data[2][0] = (T)v20; data[2][1] = (T)v21; data[2][2] = (T)v22; data[2][3] = (T)v23;
        data[3][0] = (T)v30; data[3][1] = (T)v31; data[3][2] = (T)v32; data[3][3] = (T)v33;
    }
    // clang-format on
...
template<typename T> TMatrix4x4<T> Inverse(const TMatrix4x4<T>& m)
{
...
template<typename T> inline TMatrix4x4<T> operator*(const TMatrix4x4<T>& m0, const TMatrix4x4<T>& m1)
{
    TMatrix4x4<T> ret;
    for (int i = 0; i < 4; i++) {
        for (int j = 0; j < 4; j++) {
...
template<typename T> inline std::ostream& operator<<(std::ostream& os, const TMatrix4x4<T>& m)
{
